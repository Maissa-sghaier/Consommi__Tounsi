...
public class CodePromo implements Serializable {
	...
	private boolean status_CodePromo=true;
	private int available_nbr;
	...
	public int getAvailable_nbr() {
		return available_nbr;
	}

	public void setAvailable_nbr(int available_nbr) {
		this.available_nbr = available_nbr;
	}
