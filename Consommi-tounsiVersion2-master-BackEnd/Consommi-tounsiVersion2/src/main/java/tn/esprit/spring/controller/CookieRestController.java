...
public class CookieRestController {
    ...
    public ResponseEntity setCookie() {
	 ...
	 ResponseCookie resCookie = ResponseCookie.from("user-id", "mounalalala")
	            .httpOnly(true)
	            .secure(true)
	            .path("/")
	            .maxAge(1 * 24 * 60 * 60)
    ...
    public String readCookie(@CookieValue(name = "user-id", defaultValue = "manou") String cookieName) {
