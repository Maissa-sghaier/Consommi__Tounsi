...
import tn.esprit.spring.services.CookieService;
...
public class ServletCookieController {
	    ...
	    public String setCookie(HttpServletRequest request, HttpServletResponse response) {
	    	...
	    	Cookie servletCookie = CookieService.createCookie("user-id", "c2FtLnNtaXRoQGV4YW1wbGUuY29t", 1 * 24 * 60 * 60, true, true, "/", request.getServerName());
	    ...
	    public String deleteCookie(HttpServletRequest request, HttpServletResponse response) {
	    	...
	    	Cookie deleteServletookie = CookieService.createCookie("user-id", null, 0, true, true, "/", request.getServerName());
	    ...
	    public String readAllCookies(HttpServletRequest request) {
	    	...
	    	return CookieService.readCookie(request, "user-id").orElse("cookie with name \"user-id\" is missing");
